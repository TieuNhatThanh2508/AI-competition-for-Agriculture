...
def _resnet(arch, block, layers, pretrained, progress,num_classes=1000,in_channels=36, **kwargs):
...
def _resnet50(name='resnet50',pretrained=False, progress=True,num_classes=1000,out_keys=None, in_channels=36, **kwargs):
    ...
    return _resnet(name, Bottleneck, [3, 4, 6, 3], pretrained, progress, 
                   ...
                   in_channels=in_channels, **kwargs) # passed in_channels
...
def get_resnet(name='resnet50',pretrained=False,progress=True,
               num_classes=1000,out_keys=None,in_channels=36,**kwargs):
    '''
...
if __name__=='__main__':
    model=get_resnet('resnet50',pretrained=True,num_classes=None,in_channels=3,
