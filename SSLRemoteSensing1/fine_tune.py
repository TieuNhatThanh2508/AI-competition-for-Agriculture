...
#
parse.add_argument('--checkpoints_path',default=r'E:/SSLRemoteSensing/checkpoints/checkpoints_resnet50_imagenet_inpainting_agr_examplar_total_finetune/latest.pth',type=str)
...
if __name__=='__main__':
    ...
    models.run_finetune_interface(checkpoint_path=args.checkpoints_path,
